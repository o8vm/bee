...
mutual
/-- Type quantifiers: k_ex1529505_ : Bool, level : Nat, k_ex1529503_ : Bool, k_ex1529502_ : Bool, sv_width
...
level).toNat
/-- Type quantifiers: k_ex1529496_ : Bool, k_ex1529495_ : Bool, sv_width : Nat, is_sv_or_svx4_mode(sv_width) -/
...
1000).toNat
/-- Type quantifiers: tlb_index : Nat, k_ex1529489_ : Bool, k_ex1529488_ : Bool, sv_width : Nat, is_sv_or_svx4_mode(sv_width), 0
...
1000).toNat
/-- Type quantifiers: k_ex1529483_ : Bool, k_ex1529482_ : Bool, sv_width : Nat, is_sv_or_svx4_mode(sv_width) -/
