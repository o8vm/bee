...
// top-level README) on how to get the associated schema.
{
  "base": {
    ...
    // The bits in this value control whether the corresponding bits
    // of the `hcounteren` CSR that control access to HPM counters,
