...
#
get_filename_component(filename "/home/runner/work/bee/bee/sail-build/_deps/jsoncons-tmp/v1.8.1.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/bee/bee/sail-build/_deps/jsoncons-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-jsoncons${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-jsoncons${i}")
