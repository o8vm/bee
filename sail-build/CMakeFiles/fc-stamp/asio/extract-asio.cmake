...
#
get_filename_component(filename "/home/runner/work/bee/bee/sail-build/_deps/asio-tmp/asio-1.36.0.tar.bz2" ABSOLUTE)
get_filename_component(directory "/home/runner/work/bee/bee/sail-build/_deps/asio-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-asio${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-asio${i}")
